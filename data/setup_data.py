...
def setup_from_huggingface():
    ...
    try:
        ds = load_dataset("ucsbnlp/liar", revision="main", trust_remote_code=False)  # nosec B615 — trust_remote_code removed; SHA pinning impractical for this dataset
    except Exception:
        # Fallback: try loading without scripts
        try:
            ds = load_dataset("ucsbnlp/liar", revision="main", trust_remote_code=False)  # nosec B615
        except Exception:
